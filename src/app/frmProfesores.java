...
public class frmProfesores extends javax.swing.JFrame {
    ...
    public void limpiartabla(DefaultTableModel model) {
        for (int i = 0; i < tblProfesores.getRowCount(); i++) {
            modelo.removeRow(i);
            i = i - 1;
        }
    }
    ...
    public void listar() {
        ...
        try {
            ...
            modelo = (DefaultTableModel) tblProfesores.getModel();
            ...
            while (rs.next()) {
                ...
                profesores[4] = rs.getString("codigo");
                profesores[5] = rs.getString("cursos");
                profesores[6] = rs.getString("correo");
    ...
    public void agregar() {
        ...
        if (Integer.toString(id).equals("") || nom.equals("") || ape.equals("") || Long.toString(cc).equals("") || codigo.equals("") || cursos.equals("") || correo.equals("")) {
            ...
            String SQL = "INSERT INTO profesores (id_profesor,nombres, apellidos, cc ,codigo,cursos, correo) VALUES ('"+id+"','" + nom + "','" + ape + "','" + cc + "','" + codigo + "','" + cursos + "','" + correo + "')";
            try {
                cn = con.getConnection();
                st = cn.createStatement();
    ...
    public void modificar() {
        ...
        String SQL = "UPDATE profesores SET id_profesor='"+id+"', nombres='" + nom + "', apellidos='" + ape + "', cc='" + cc + "', codigo='"+codigo+"', cursos='" + cursos + "', correo='" + correo + "' WHERE id_profesor=' " + id + "'";
        if (Integer.toString(id).equals("") || nom.equals("") || ape.equals("") || Long.toString(cc).equals("") || codigo.equals("") || cursos.equals("") || correo.equals("")) {
    ...
    public void eliminar() {
        ...
        int seleccionado = tblProfesores.getSelectedRow();
        if (seleccionado < 0) {
    ...
    private void initComponents() {
        ...
        tblProfesores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOMBRES", "APELLIDOS", "CC", "CODIGO", "CURSOS", "CORREO"
            }
        ));
    ...
    private void tblProfesoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblProfesoresMouseClicked
        ...
        if (fila == -1) {
            ...
            id = Integer.parseInt(tblProfesores.getValueAt(fila, 0).toString());
            nom = tblProfesores.getValueAt(fila, 1).toString();
            ape = tblProfesores.getValueAt(fila, 2).toString();
            cc = Long.parseLong((String) tblProfesores.getValueAt(fila, 3).toString());
            codigo = tblProfesores.getValueAt(fila, 4).toString();
            cursos = tblProfesores.getValueAt(fila, 5).toString();
            correo = tblProfesores.getValueAt(fila, 6).toString();
