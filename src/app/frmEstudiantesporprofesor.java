 ...
 * @author Universidad
 */
public final class frmEstudiantesporprofesor extends javax.swing.JFrame {
     ...
     */
    public frmEstudiantesporprofesor() {
        initComponents();
    ...
    public void listar_estudiante() {
        ...
        if (cboCursos.getSelectedItem().equals("Seleccione")) {
            ...
            try {
                ...
                modelo1 = (DefaultTableModel) tblEstudiantesporcurso.getModel();
...
//Ordenar lista estudiante

    public void ordenarlista_estudiante() {
        if (cboCursos.getSelectedItem().equals("Seleccione")) {
            String SQL = "SELECT * FROM estudiantes";
    ...
    public void limpiar_tablaEstudiantes(DefaultTableModel model) {
    ...
    public void limpiar_tablaProfesores(DefaultTableModel model) {
        for (int j = 0; j < tblProfesor.getRowCount(); j++) {
            modelo2.removeRow(j);
            j = j - 1;
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(41, 43, 45)), "Profesor", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Roboto Light", 1, 12), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        tblProfesor.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOMBRES", "APELLIDOS", "CC", "CODIGO", "CORREO", "CURSO"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false, false
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenarActionPerformed
        // TODO add your handling code here:
        limpiar_tablaEstudiantes(modelo1);
        ordenarlista_estudiante();
        limpiar_tablaProfesores(modelo2);
        ordenarlista_profesor();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEstudiantesporprofesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmEstudiantesporprofesor().setVisible(true);
            }
        });
    }
